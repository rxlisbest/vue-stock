      ...
      <el-row>
        <el-col :span="18">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ name: 'goods-add' }">{{$t('messages.crumb.add')}}</el-breadcrumb-item>
          </el-breadcrumb>
        </el-col>
      </el-row>
  ...
  export default {
    ...
    data () {
      ...
      function repeatName (rule, value, callback) {
        _this.axios.get(_this.api.goods.repeat, {params: {name: value}})
    ...
    methods: {
      onSubmit () {
        ...
        _this.$refs.ruleForm.validate((valid) => {
          if (valid) {
            this.axios.post(this.api.goods.create, _this.form)
            .then(function (response) {
